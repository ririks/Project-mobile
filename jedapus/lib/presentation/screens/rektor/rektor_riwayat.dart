...
class RektorRiwayatScreen extends StatefulWidget {
  const RektorRiwayatScreen({super.key});

  @override
  State<RektorRiwayatScreen> createState() => _RektorRiwayatScreenState();
}

class _RektorRiwayatScreenState extends State<RektorRiwayatScreen> {
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          Text(
            'Lihat semua keputusan pengajuan cuti',
            style: GoogleFonts.montserrat(
  ...
  Widget _buildRiwayatCard(pengajuan) {
    ...
    return Container(
      ...
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          // Header dengan nama pegawai dan status
          Row(
          ...
          // Tanggal keputusan
          if (pengajuan.tanggalKeputusan != null) ...[
            const SizedBox(height: 8),
            Row(
              children: [
                Icon(
                ...
                const SizedBox(width: 6),
                Text(
                  'Diputuskan: ${_formatDateTime(pengajuan.tanggalKeputusan!)}',
                  style: GoogleFonts.montserrat(
                    fontSize: 12,
                    color: const Color(0xFF718096),
                  ),
